package com.robindrew.filetransfer.jetty;
...
import com.robindrew.filetransfer.jetty.page.ViewDirectoryExecutor;
...
public class JettyComponent extends JettyVelocityComponent {
	...
	protected void populate(MatcherHttpHandler handler) {
		...
		handler.uri("/ViewDirectory", new ViewDirectoryExecutor());
	}
